...
import { LayoutDashboard, Users, Settings, Shield, ChevronLeft, ChevronRight, Activity, LogOut } from 'lucide-react';
                ...
                {(canManageUsers || isSuperAdmin) && (
                    <div className="py-2">
                        ...
                        <div className="space-y-1">
                            ...
                            {isSuperAdmin && (
                                <SidebarItem to="/moderation" icon={Shield} label="Moderation" collapsed={collapsed} />
                            )}
                        </div>
                    </div>
                )}
